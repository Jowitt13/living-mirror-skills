...
2. 蒸馏框架层
   Part A：自我记忆五维度
   Part B：人格五层
   证据分级 + CONFLICT 追踪 + Correction + 版本管理
...
8. 每个主题报告完成后让用户复核。
9. 合并成 `self-portrait-YYYY-MM.md`。
10. 更新 `manifest.json`、`changelog.md`、`conflicts.md`、`corrections.md`。
