...
> 一套本地优先、带证据、可纠正、可复核、可行动的自我理解 Skill。它可以从杂乱记录开始，也可以从零数据访谈开始，把碎片整理成自画像、复核问题、行动实验、关系地图和可公开分享的脱敏模板。
...
v0.6 已经解决了证据、情境、矛盾和纠正。v0.9 把它进一步做成普通人也能开始、敢用、用完能行动、还能安全展示的完整工作流。
